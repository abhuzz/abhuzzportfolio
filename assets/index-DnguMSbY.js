(function(){const E=document.createElement("link").relList;if(E&&E.supports&&E.supports("modulepreload"))return;for(const D of document.querySelectorAll('link[rel="modulepreload"]'))m(D);new MutationObserver(D=>{for(const B of D)if(B.type==="childList")for(const w of B.addedNodes)w.tagName==="LINK"&&w.rel==="modulepreload"&&m(w)}).observe(document,{childList:!0,subtree:!0});function M(D){const B={};return D.integrity&&(B.integrity=D.integrity),D.referrerPolicy&&(B.referrerPolicy=D.referrerPolicy),D.crossOrigin==="use-credentials"?B.credentials="include":D.crossOrigin==="anonymous"?B.credentials="omit":B.credentials="same-origin",B}function m(D){if(D.ep)return;D.ep=!0;const B=M(D);fetch(D.href,B)}})();var of={exports:{}},zn={};var zd;function sh(){if(zd)return zn;zd=1;var z=Symbol.for("react.transitional.element"),E=Symbol.for("react.fragment");function M(m,D,B){var w=null;if(B!==void 0&&(w=""+B),D.key!==void 0&&(w=""+D.key),"key"in D){B={};for(var at in D)at!=="key"&&(B[at]=D[at])}else B=D;return D=B.ref,{$$typeof:z,type:m,key:w,ref:D!==void 0?D:null,props:B}}return zn.Fragment=E,zn.jsx=M,zn.jsxs=M,zn}var Ad;function rh(){return Ad||(Ad=1,of.exports=sh()),of.exports}var f=rh(),sf={exports:{}},G={};var jd;function dh(){if(jd)return G;jd=1;var z=Symbol.for("react.transitional.element"),E=Symbol.for("react.portal"),M=Symbol.for("react.fragment"),m=Symbol.for("react.strict_mode"),D=Symbol.for("react.profiler"),B=Symbol.for("react.consumer"),w=Symbol.for("react.context"),at=Symbol.for("react.forward_ref"),_=Symbol.for("react.suspense"),A=Symbol.for("react.memo"),Q=Symbol.for("react.lazy"),H=Symbol.for("react.activity"),F=Symbol.iterator;function Ft(r){return r===null||typeof r!="object"?null:(r=F&&r[F]||r["@@iterator"],typeof r=="function"?r:null)}var wt={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Bt=Object.assign,De={};function $t(r,j,N){this.props=r,this.context=j,this.refs=De,this.updater=N||wt}$t.prototype.isReactComponent={},$t.prototype.setState=function(r,j){if(typeof r!="object"&&typeof r!="function"&&r!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,r,j,"setState")},$t.prototype.forceUpdate=function(r){this.updater.enqueueForceUpdate(this,r,"forceUpdate")};function $e(){}$e.prototype=$t.prototype;function Ut(r,j,N){this.props=r,this.context=j,this.refs=De,this.updater=N||wt}var fe=Ut.prototype=new $e;fe.constructor=Ut,Bt(fe,$t.prototype),fe.isPureReactComponent=!0;var Ae=Array.isArray;function Gt(){}var $={H:null,A:null,T:null,S:null},Xt=Object.prototype.hasOwnProperty;function je(r,j,N){var C=N.ref;return{$$typeof:z,type:r,key:j,ref:C!==void 0?C:null,props:N}}function Ql(r,j){return je(r.type,j,r.props)}function Ee(r){return typeof r=="object"&&r!==null&&r.$$typeof===z}function Lt(r){var j={"=":"=0",":":"=2"};return"$"+r.replace(/[=:]/g,function(N){return j[N]})}var Al=/\/+/g;function Ce(r,j){return typeof r=="object"&&r!==null&&r.key!=null?Lt(""+r.key):j.toString(36)}function be(r){switch(r.status){case"fulfilled":return r.value;case"rejected":throw r.reason;default:switch(typeof r.status=="string"?r.then(Gt,Gt):(r.status="pending",r.then(function(j){r.status==="pending"&&(r.status="fulfilled",r.value=j)},function(j){r.status==="pending"&&(r.status="rejected",r.reason=j)})),r.status){case"fulfilled":return r.value;case"rejected":throw r.reason}}throw r}function b(r,j,N,C,X){var V=typeof r;(V==="undefined"||V==="boolean")&&(r=null);var lt=!1;if(r===null)lt=!0;else switch(V){case"bigint":case"string":case"number":lt=!0;break;case"object":switch(r.$$typeof){case z:case E:lt=!0;break;case Q:return lt=r._init,b(lt(r._payload),j,N,C,X)}}if(lt)return X=X(r),lt=C===""?"."+Ce(r,0):C,Ae(X)?(N="",lt!=null&&(N=lt.replace(Al,"$&/")+"/"),b(X,j,N,"",function(Ma){return Ma})):X!=null&&(Ee(X)&&(X=Ql(X,N+(X.key==null||r&&r.key===X.key?"":(""+X.key).replace(Al,"$&/")+"/")+lt)),j.push(X)),1;lt=0;var qt=C===""?".":C+":";if(Ae(r))for(var vt=0;vt<r.length;vt++)C=r[vt],V=qt+Ce(C,vt),lt+=b(C,j,N,V,X);else if(vt=Ft(r),typeof vt=="function")for(r=vt.call(r),vt=0;!(C=r.next()).done;)C=C.value,V=qt+Ce(C,vt++),lt+=b(C,j,N,V,X);else if(V==="object"){if(typeof r.then=="function")return b(be(r),j,N,C,X);throw j=String(r),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(r).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return lt}function T(r,j,N){if(r==null)return r;var C=[],X=0;return b(r,C,"","",function(V){return j.call(N,V,X++)}),C}function Y(r){if(r._status===-1){var j=r._result;j=j(),j.then(function(N){(r._status===0||r._status===-1)&&(r._status=1,r._result=N)},function(N){(r._status===0||r._status===-1)&&(r._status=2,r._result=N)}),r._status===-1&&(r._status=0,r._result=j)}if(r._status===1)return r._result.default;throw r._result}var ut=typeof reportError=="function"?reportError:function(r){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof r=="object"&&r!==null&&typeof r.message=="string"?String(r.message):String(r),error:r});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",r);return}console.error(r)},st={map:T,forEach:function(r,j,N){T(r,function(){j.apply(this,arguments)},N)},count:function(r){var j=0;return T(r,function(){j++}),j},toArray:function(r){return T(r,function(j){return j})||[]},only:function(r){if(!Ee(r))throw Error("React.Children.only expected to receive a single React element child.");return r}};return G.Activity=H,G.Children=st,G.Component=$t,G.Fragment=M,G.Profiler=D,G.PureComponent=Ut,G.StrictMode=m,G.Suspense=_,G.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=$,G.__COMPILER_RUNTIME={__proto__:null,c:function(r){return $.H.useMemoCache(r)}},G.cache=function(r){return function(){return r.apply(null,arguments)}},G.cacheSignal=function(){return null},G.cloneElement=function(r,j,N){if(r==null)throw Error("The argument must be a React element, but you passed "+r+".");var C=Bt({},r.props),X=r.key;if(j!=null)for(V in j.key!==void 0&&(X=""+j.key),j)!Xt.call(j,V)||V==="key"||V==="__self"||V==="__source"||V==="ref"&&j.ref===void 0||(C[V]=j[V]);var V=arguments.length-2;if(V===1)C.children=N;else if(1<V){for(var lt=Array(V),qt=0;qt<V;qt++)lt[qt]=arguments[qt+2];C.children=lt}return je(r.type,X,C)},G.createContext=function(r){return r={$$typeof:w,_currentValue:r,_currentValue2:r,_threadCount:0,Provider:null,Consumer:null},r.Provider=r,r.Consumer={$$typeof:B,_context:r},r},G.createElement=function(r,j,N){var C,X={},V=null;if(j!=null)for(C in j.key!==void 0&&(V=""+j.key),j)Xt.call(j,C)&&C!=="key"&&C!=="__self"&&C!=="__source"&&(X[C]=j[C]);var lt=arguments.length-2;if(lt===1)X.children=N;else if(1<lt){for(var qt=Array(lt),vt=0;vt<lt;vt++)qt[vt]=arguments[vt+2];X.children=qt}if(r&&r.defaultProps)for(C in lt=r.defaultProps,lt)X[C]===void 0&&(X[C]=lt[C]);return je(r,V,X)},G.createRef=function(){return{current:null}},G.forwardRef=function(r){return{$$typeof:at,render:r}},G.isValidElement=Ee,G.lazy=function(r){return{$$typeof:Q,_payload:{_status:-1,_result:r},_init:Y}},G.memo=function(r,j){return{$$typeof:A,type:r,compare:j===void 0?null:j}},G.startTransition=function(r){var j=$.T,N={};$.T=N;try{var C=r(),X=$.S;X!==null&&X(N,C),typeof C=="object"&&C!==null&&typeof C.then=="function"&&C.then(Gt,ut)}catch(V){ut(V)}finally{j!==null&&N.types!==null&&(j.types=N.types),$.T=j}},G.unstable_useCacheRefresh=function(){return $.H.useCacheRefresh()},G.use=function(r){return $.H.use(r)},G.useActionState=function(r,j,N){return $.H.useActionState(r,j,N)},G.useCallback=function(r,j){return $.H.useCallback(r,j)},G.useContext=function(r){return $.H.useContext(r)},G.useDebugValue=function(){},G.useDeferredValue=function(r,j){return $.H.useDeferredValue(r,j)},G.useEffect=function(r,j){return $.H.useEffect(r,j)},G.useEffectEvent=function(r){return $.H.useEffectEvent(r)},G.useId=function(){return $.H.useId()},G.useImperativeHandle=function(r,j,N){return $.H.useImperativeHandle(r,j,N)},G.useInsertionEffect=function(r,j){return $.H.useInsertionEffect(r,j)},G.useLayoutEffect=function(r,j){return $.H.useLayoutEffect(r,j)},G.useMemo=function(r,j){return $.H.useMemo(r,j)},G.useOptimistic=function(r,j){return $.H.useOptimistic(r,j)},G.useReducer=function(r,j,N){return $.H.useReducer(r,j,N)},G.useRef=function(r){return $.H.useRef(r)},G.useState=function(r){return $.H.useState(r)},G.useSyncExternalStore=function(r,j,N){return $.H.useSyncExternalStore(r,j,N)},G.useTransition=function(){return $.H.useTransition()},G.version="19.2.3",G}var Ed;function vf(){return Ed||(Ed=1,sf.exports=dh()),sf.exports}var Rt=vf(),rf={exports:{}},An={},df={exports:{}},mf={};var Td;function mh(){return Td||(Td=1,(function(z){function E(b,T){var Y=b.length;b.push(T);t:for(;0<Y;){var ut=Y-1>>>1,st=b[ut];if(0<D(st,T))b[ut]=T,b[Y]=st,Y=ut;else break t}}function M(b){return b.length===0?null:b[0]}function m(b){if(b.length===0)return null;var T=b[0],Y=b.pop();if(Y!==T){b[0]=Y;t:for(var ut=0,st=b.length,r=st>>>1;ut<r;){var j=2*(ut+1)-1,N=b[j],C=j+1,X=b[C];if(0>D(N,Y))C<st&&0>D(X,N)?(b[ut]=X,b[C]=Y,ut=C):(b[ut]=N,b[j]=Y,ut=j);else if(C<st&&0>D(X,Y))b[ut]=X,b[C]=Y,ut=C;else break t}}return T}function D(b,T){var Y=b.sortIndex-T.sortIndex;return Y!==0?Y:b.id-T.id}if(z.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var B=performance;z.unstable_now=function(){return B.now()}}else{var w=Date,at=w.now();z.unstable_now=function(){return w.now()-at}}var _=[],A=[],Q=1,H=null,F=3,Ft=!1,wt=!1,Bt=!1,De=!1,$t=typeof setTimeout=="function"?setTimeout:null,$e=typeof clearTimeout=="function"?clearTimeout:null,Ut=typeof setImmediate<"u"?setImmediate:null;function fe(b){for(var T=M(A);T!==null;){if(T.callback===null)m(A);else if(T.startTime<=b)m(A),T.sortIndex=T.expirationTime,E(_,T);else break;T=M(A)}}function Ae(b){if(Bt=!1,fe(b),!wt)if(M(_)!==null)wt=!0,Gt||(Gt=!0,Lt());else{var T=M(A);T!==null&&be(Ae,T.startTime-b)}}var Gt=!1,$=-1,Xt=5,je=-1;function Ql(){return De?!0:!(z.unstable_now()-je<Xt)}function Ee(){if(De=!1,Gt){var b=z.unstable_now();je=b;var T=!0;try{t:{wt=!1,Bt&&(Bt=!1,$e($),$=-1),Ft=!0;var Y=F;try{e:{for(fe(b),H=M(_);H!==null&&!(H.expirationTime>b&&Ql());){var ut=H.callback;if(typeof ut=="function"){H.callback=null,F=H.priorityLevel;var st=ut(H.expirationTime<=b);if(b=z.unstable_now(),typeof st=="function"){H.callback=st,fe(b),T=!0;break e}H===M(_)&&m(_),fe(b)}else m(_);H=M(_)}if(H!==null)T=!0;else{var r=M(A);r!==null&&be(Ae,r.startTime-b),T=!1}}break t}finally{H=null,F=Y,Ft=!1}T=void 0}}finally{T?Lt():Gt=!1}}}var Lt;if(typeof Ut=="function")Lt=function(){Ut(Ee)};else if(typeof MessageChannel<"u"){var Al=new MessageChannel,Ce=Al.port2;Al.port1.onmessage=Ee,Lt=function(){Ce.postMessage(null)}}else Lt=function(){$t(Ee,0)};function be(b,T){$=$t(function(){b(z.unstable_now())},T)}z.unstable_IdlePriority=5,z.unstable_ImmediatePriority=1,z.unstable_LowPriority=4,z.unstable_NormalPriority=3,z.unstable_Profiling=null,z.unstable_UserBlockingPriority=2,z.unstable_cancelCallback=function(b){b.callback=null},z.unstable_forceFrameRate=function(b){0>b||125<b?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Xt=0<b?Math.floor(1e3/b):5},z.unstable_getCurrentPriorityLevel=function(){return F},z.unstable_next=function(b){switch(F){case 1:case 2:case 3:var T=3;break;default:T=F}var Y=F;F=T;try{return b()}finally{F=Y}},z.unstable_requestPaint=function(){De=!0},z.unstable_runWithPriority=function(b,T){switch(b){case 1:case 2:case 3:case 4:case 5:break;default:b=3}var Y=F;F=b;try{return T()}finally{F=Y}},z.unstable_scheduleCallback=function(b,T,Y){var ut=z.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?ut+Y:ut):Y=ut,b){case 1:var st=-1;break;case 2:st=250;break;case 5:st=1073741823;break;case 4:st=1e4;break;default:st=5e3}return st=Y+st,b={id:Q++,callback:T,priorityLevel:b,startTime:Y,expirationTime:st,sortIndex:-1},Y>ut?(b.sortIndex=Y,E(A,b),M(_)===null&&b===M(A)&&(Bt?($e($),$=-1):Bt=!0,be(Ae,Y-ut))):(b.sortIndex=st,E(_,b),wt||Ft||(wt=!0,Gt||(Gt=!0,Lt()))),b},z.unstable_shouldYield=Ql,z.unstable_wrapCallback=function(b){var T=F;return function(){var Y=F;F=T;try{return b.apply(this,arguments)}finally{F=Y}}}})(mf)),mf}var Nd;function hh(){return Nd||(Nd=1,df.exports=mh()),df.exports}var hf={exports:{}},Ht={};var Md;function gh(){if(Md)return Ht;Md=1;var z=vf();function E(_){var A="https://react.dev/errors/"+_;if(1<arguments.length){A+="?args[]="+encodeURIComponent(arguments[1]);for(var Q=2;Q<arguments.length;Q++)A+="&args[]="+encodeURIComponent(arguments[Q])}return"Minified React error #"+_+"; visit "+A+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function M(){}var m={d:{f:M,r:function(){throw Error(E(522))},D:M,C:M,L:M,m:M,X:M,S:M,M},p:0,findDOMNode:null},D=Symbol.for("react.portal");function B(_,A,Q){var H=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:D,key:H==null?null:""+H,children:_,containerInfo:A,implementation:Q}}var w=z.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function at(_,A){if(_==="font")return"";if(typeof A=="string")return A==="use-credentials"?A:""}return Ht.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=m,Ht.createPortal=function(_,A){var Q=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!A||A.nodeType!==1&&A.nodeType!==9&&A.nodeType!==11)throw Error(E(299));return B(_,A,null,Q)},Ht.flushSync=function(_){var A=w.T,Q=m.p;try{if(w.T=null,m.p=2,_)return _()}finally{w.T=A,m.p=Q,m.d.f()}},Ht.preconnect=function(_,A){typeof _=="string"&&(A?(A=A.crossOrigin,A=typeof A=="string"?A==="use-credentials"?A:"":void 0):A=null,m.d.C(_,A))},Ht.prefetchDNS=function(_){typeof _=="string"&&m.d.D(_)},Ht.preinit=function(_,A){if(typeof _=="string"&&A&&typeof A.as=="string"){var Q=A.as,H=at(Q,A.crossOrigin),F=typeof A.integrity=="string"?A.integrity:void 0,Ft=typeof A.fetchPriority=="string"?A.fetchPriority:void 0;Q==="style"?m.d.S(_,typeof A.precedence=="string"?A.precedence:void 0,{crossOrigin:H,integrity:F,fetchPriority:Ft}):Q==="script"&&m.d.X(_,{crossOrigin:H,integrity:F,fetchPriority:Ft,nonce:typeof A.nonce=="string"?A.nonce:void 0})}},Ht.preinitModule=function(_,A){if(typeof _=="string")if(typeof A=="object"&&A!==null){if(A.as==null||A.as==="script"){var Q=at(A.as,A.crossOrigin);m.d.M(_,{crossOrigin:Q,integrity:typeof A.integrity=="string"?A.integrity:void 0,nonce:typeof A.nonce=="string"?A.nonce:void 0})}}else A==null&&m.d.M(_)},Ht.preload=function(_,A){if(typeof _=="string"&&typeof A=="object"&&A!==null&&typeof A.as=="string"){var Q=A.as,H=at(Q,A.crossOrigin);m.d.L(_,Q,{crossOrigin:H,integrity:typeof A.integrity=="string"?A.integrity:void 0,nonce:typeof A.nonce=="string"?A.nonce:void 0,type:typeof A.type=="string"?A.type:void 0,fetchPriority:typeof A.fetchPriority=="string"?A.fetchPriority:void 0,referrerPolicy:typeof A.referrerPolicy=="string"?A.referrerPolicy:void 0,imageSrcSet:typeof A.imageSrcSet=="string"?A.imageSrcSet:void 0,imageSizes:typeof A.imageSizes=="string"?A.imageSizes:void 0,media:typeof A.media=="string"?A.media:void 0})}},Ht.preloadModule=function(_,A){if(typeof _=="string")if(A){var Q=at(A.as,A.crossOrigin);m.d.m(_,{as:typeof A.as=="string"&&A.as!=="script"?A.as:void 0,crossOrigin:Q,integrity:typeof A.integrity=="string"?A.integrity:void 0})}else m.d.m(_)},Ht.requestFormReset=function(_){m.d.r(_)},Ht.unstable_batchedUpdates=function(_,A){return _(A)},Ht.useFormState=function(_,A,Q){return w.H.useFormState(_,A,Q)},Ht.useFormStatus=function(){return w.H.useHostTransitionStatus()},Ht.version="19.2.3",Ht}var _d;function ph(){if(_d)return hf.exports;_d=1;function z(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(z)}catch(E){console.error(E)}}return z(),hf.exports=gh(),hf.exports}var Od;function yh(){if(Od)return An;Od=1;var z=hh(),E=vf(),M=ph();function m(t){var e="https://react.dev/errors/"+t;if(1<arguments.length){e+="?args[]="+encodeURIComponent(arguments[1]);for(var l=2;l<arguments.length;l++)e+="&args[]="+encodeURIComponent(arguments[l])}return"Minified React error #"+t+"; visit "+e+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function D(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function B(t){var e=t,l=t;if(t.alternate)for(;e.return;)e=e.return;else{t=e;do e=t,(e.flags&4098)!==0&&(l=e.return),t=e.return;while(t)}return e.tag===3?l:null}function w(t){if(t.tag===13){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function at(t){if(t.tag===31){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function _(t){if(B(t)!==t)throw Error(m(188))}function A(t){var e=t.alternate;if(!e){if(e=B(t),e===null)throw Error(m(188));return e!==t?null:t}for(var l=t,a=e;;){var n=l.return;if(n===null)break;var i=n.alternate;if(i===null){if(a=n.return,a!==null){l=a;continue}break}if(n.child===i.child){for(i=n.child;i;){if(i===l)return _(n),t;if(i===a)return _(n),e;i=i.sibling}throw Error(m(188))}if(l.return!==a.return)l=n,a=i;else{for(var u=!1,c=n.child;c;){if(c===l){u=!0,l=n,a=i;break}if(c===a){u=!0,a=n,l=i;break}c=c.sibling}if(!u){for(c=i.child;c;){if(c===l){u=!0,l=i,a=n;break}if(c===a){u=!0,a=i,l=n;break}c=c.sibling}if(!u)throw Error(m(189))}}if(l.alternate!==a)throw Error(m(190))}if(l.tag!==3)throw Error(m(188));return l.stateNode.current===l?t:e}function Q(t){var e=t.tag;if(e===5||e===26||e===27||e===6)return t;for(t=t.child;t!==null;){if(e=Q(t),e!==null)return e;t=t.sibling}return null}var H=Object.assign,F=Symbol.for("react.element"),Ft=Symbol.for("react.transitional.element"),wt=Symbol.for("react.portal"),Bt=Symbol.for("react.fragment"),De=Symbol.for("react.strict_mode"),$t=Symbol.for("react.profiler"),$e=Symbol.for("react.consumer"),Ut=Symbol.for("react.context"),fe=Symbol.for("react.forward_ref"),Ae=Symbol.for("react.suspense"),Gt=Symbol.for("react.suspense_list"),$=Symbol.for("react.memo"),Xt=Symbol.for("react.lazy"),je=Symbol.for("react.activity"),Ql=Symbol.for("react.memo_cache_sentinel"),Ee=Symbol.iterator;function Lt(t){return t===null||typeof t!="object"?null:(t=Ee&&t[Ee]||t["@@iterator"],typeof t=="function"?t:null)}var Al=Symbol.for("react.client.reference");function Ce(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===Al?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case Bt:return"Fragment";case $t:return"Profiler";case De:return"StrictMode";case Ae:return"Suspense";case Gt:return"SuspenseList";case je:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case wt:return"Portal";case Ut:return t.displayName||"Context";case $e:return(t._context.displayName||"Context")+".Consumer";case fe:var e=t.render;return t=t.displayName,t||(t=e.displayName||e.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case $:return e=t.displayName||null,e!==null?e:Ce(t.type)||"Memo";case Xt:e=t._payload,t=t._init;try{return Ce(t(e))}catch{}}return null}var be=Array.isArray,b=E.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,T=M.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Y={pending:!1,data:null,method:null,action:null},ut=[],st=-1;function r(t){return{current:t}}function j(t){0>st||(t.current=ut[st],ut[st]=null,st--)}function N(t,e){st++,ut[st]=t.current,t.current=e}var C=r(null),X=r(null),V=r(null),lt=r(null);function qt(t,e){switch(N(V,e),N(X,t),N(C,null),e.nodeType){case 9:case 11:t=(t=e.documentElement)&&(t=t.namespaceURI)?Vr(t):0;break;default:if(t=e.tagName,e=e.namespaceURI)e=Vr(e),t=Kr(e,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}j(C),N(C,t)}function vt(){j(C),j(X),j(V)}function Ma(t){t.memoizedState!==null&&N(lt,t);var e=C.current,l=Kr(e,t.type);e!==l&&(N(X,t),N(C,l))}function jn(t){X.current===t&&(j(C),j(X)),lt.current===t&&(j(lt),vn._currentValue=Y)}var Zi,xf;function jl(t){if(Zi===void 0)try{throw Error()}catch(l){var e=l.stack.trim().match(/\n( *(at )?)/);Zi=e&&e[1]||"",xf=-1<l.stack.indexOf(`
